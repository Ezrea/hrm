								...
								<tr height="35">
									<td style="width:50px;">角色组:</td>
										...
										<c:forEach items="${roleList}" var="role" varStatus="vs">
											<td style="width:100px;" class="center" <c:choose><c:when test="${pd.ROLE_ID == role.ROLE_ID}">bgcolor="#FFC926" onMouseOut="this.bgColor='#FFC926';" </c:when><c:otherwise>bgcolor="#E5E5E5" onMouseOut="this.bgColor='#E5E5E5';"</c:otherwise></c:choose> onMouseMove="this.bgColor='#FFC926';" >
